...
-- -----------------------------------------------------
-- Table `todo_list`.`task_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `todo_list`.`task_status` ;

CREATE TABLE IF NOT EXISTS `todo_list`.`task_status` (
...
CREATE TABLE IF NOT EXISTS `todo_list`.`tasks` (
  ...
  `status_id` INT NOT NULL DEFAULT 0000,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  CONSTRAINT `status`
    ...
    REFERENCES `todo_list`.`task_status` (`status_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `parent`
...
CREATE TABLE IF NOT EXISTS `todo_list`.`requests_task` (
  ...
  `task_id` INT NOT NULL,
  `user_id` INT NOT NULL,
  `status` ENUM('pending', 'accepted', 'declined') NULL DEFAULT 'pending',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
